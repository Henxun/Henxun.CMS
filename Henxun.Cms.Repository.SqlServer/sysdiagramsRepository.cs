...
{
    public class sysdiagramsRepository:BaseRepository<sysdiagrams,Int32>, IsysdiagramsRepository
    {
        public sysdiagramsRepository(IOptionsSnapshot<DbOption> options)
        {
        ...
        {
            string sql = "update sysdiagrams set IsDelete=1 where Id in @Ids";
